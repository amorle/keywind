                ...
                <tr>
                  <td>
                    <table
                      ...
                      role='presentation'
                      style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: ${properties.contentBgColor}; width: 640px;"
                      width='640'
                    >
                      <tbody>
                        <tr>
                              ...
                              <tr>
                                ...
                                >
                                  <div style='font-family: sans-serif'>
                                    <div
                                      class=''
                                      style='font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 14.399999999999999px; line-height: 1.2;'
                                    >
                                      <p
                                        style='margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;'
                                      ><span
                                          style="font-size:30px;color:${properties.titleTextColor};"
                                        ><strong><#nested "subject"></strong></span></p>
                                    </div>
                                  </div>
                                </td>
                              </tr>
                              ...
                              <tr>
                                ...
                                >
                                  <div style='font-family: sans-serif'>
                                    <div
                                      class=''
                                      style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 18px; color: ${properties.contentTextColor}; line-height: 1.5;"
                                    >
                                      <p
                                ...
                                >
                                  <a href="${link}">
                                    <div align='center' class='alignment'>
                                      ...
                                      <div
                                        style="text-decoration:none;display:inline-block;color:${properties.buttonColor};background-color:${properties.buttonBgColor};border-radius:60px;width:auto;border-top:0px solid transparent;font-weight:undefined;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:15px;padding-bottom:15px;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:16px;text-align:center;mso-border-alt:none;word-break:keep-all;"
                                      ><span
                                          style='padding-left:30px;padding-right:30px;font-size:16px;display:inline-block;letter-spacing:normal;'
                                        ><span
                                            style='margin: 0; word-break: break-word; line-height: 32px;'
                                          ><strong
                                            ><#nested "linkText"></strong></span></span></div>
